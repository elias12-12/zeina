...
import { idParam, userIdParam, upsertSales, applyDiscountValidator , getSaleBetweenDates, getSaleByTotalAmount  } from '../validators/SalesValidators.js';
...
SalesRoutes.get('/number',getSaleByTotalAmount,controller.getSalesByTotalAmount);
